...
# Constants
# Destination MotherDuck database name. Configure via the MOTHERDUCK_DATABASE
# environment variable; falls back to a neutral default.
MD_DB = os.environ.get("MOTHERDUCK_DATABASE", "peloton_data")
